...
class _ConnectionPageState extends State<ConnectionPage> {
  ...
  /// Ребрендинг: полоса "скачать новую версию" убрана - она вела на
  /// rustdesk.com/download, то есть уводила пользователя к чужому продукту.
  /// Наш клиент раздаётся через своё приложение, а не скачиванием с сайта
  /// RustDesk (то же самое сделано для настольной версии, см.
  /// desktop/pages/desktop_home_page.dart::buildHelpCards).
